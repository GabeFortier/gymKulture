    ...
    <script>
        ...
        <?php
                if(isset($_POST["searchInput"])){
                    $query = "SELECT * FROM testtable WHERE tag LIKE '%".(string)$_POST["searchInput"]."%' OR category LIKE '%".(string)$_POST["searchInput"]."%' OR productName LIKE '%".(string)$_POST["searchInput"]."%'";
                }
                else{
