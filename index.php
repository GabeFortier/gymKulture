...
<header id="header" class="header-fixed row justify-content-between">
   ...
   <!-- class: bg-image-full  style: background-image: url('assets/back1.jpg') -->
    ...
    <a class="col-md-auto" style="display:flex; flex-wrap:wrap; justify-content:center;"href="index.php"><img src = "assets/logoVariant.png" style="width:200px; height:100px;"></a>
    <div class="text-center text-white col-md-auto header-text">
            <h1 class="display-4 text-black fw-bolder" style="margin-bottom:5px;">GYM Kulture</h1>
            <p class="lead fw-normal text-black mb-0">Shop our newest and best products to get your perfect gym attire, and find your GYM Kulture!</p>
        </div>
    </header> -->
